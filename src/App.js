...
function App({ signOut, user }) {
    ...
    async function addTodo() {
        ...
        // A difference between the listTodos query and the createTodo mutation is that createTodo accepts an argument
        // containing the variables needed for the mutation.
        try {
